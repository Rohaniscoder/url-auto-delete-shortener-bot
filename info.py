...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '5446391744').split()]
...
URL_SHORTENR_WEBSITE = environ.get('URL_SHORTENR_WEBSITE', 'easysky.im')
